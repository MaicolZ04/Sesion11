// Suma y Promedio de numeros. Parte 1
...
function ingresarNumeros() {
  ...
  while (numero >= 0) {
    ...
    document.getElementById('salidaNumeros').innerHTML = `<strong>Números ingresados:</strong> ${numerosIngresados.join(',')}<br>
  <strong>Suma total:</strong> ${suma}`;
}

// Validación de Contraseña. Parte 3
